...
describe('Expression::dependencies', function() {
  ...
  it('gets bracket dependencies', function() {
    var expression = create('_page.colors[_page.key].name');
    var expression2 = create('_page.colors[_page.key].rgb[_page.channel]');
    var expression3 = create('_page.colors[_page.key][_page.variation].hex');
    var expression4 = create('_page.colors[_page.keys[_page.index]].name');
  ...
  it('gets fn dependencies', function() {
    var expression = create('plus(_page.nums[0], _page.nums[1])');
    var expression2 = create('plus(_page.nums[0], minus(_page.nums[3], _page.nums[2]))');
    var expression3 = create('plus(_page.nums[_page.first], _page.nums[_page.second])');
    var expression4 = create('_page.keys[minus(_page.nums[2], _page.nums[0])]');
    expect(expression.dependencies(context)).to.eql([
      ['_page', 'nums', 0, '*']
    , ['_page', 'nums', 1, '*']
    ]);
  ...
  it('gets literal dependencies', function() {
    var expression = create('34');
    expect(expression.dependencies(context)).to.equal(undefined);
  });

  it('gets dependencies of operators on paths', function() {
    var expression = create('_page.nums[0] + _page.nums[1]');
    var expression2 = create('_page.nums[0] + (_page.nums[3] - _page.nums[2])');
    var expression3 = create('_page.nums[_page.first] + _page.nums[_page.second]');
    var expression4 = create('_page.keys[_page.nums[2] - _page.nums[0]]');
    expect(expression.dependencies(context)).to.eql([
      ['_page', 'nums', 0, '*']
    , ['_page', 'nums', 1, '*']
    ]);
  ...
  it('gets dependencies of operators on mixed literals and paths', function() {
    var expression = create('_page.nums[0] + 3');
    var expression2 = create('_page.nums[0] + (100 - _page.nums[2])');
    var expression3 = create('_page.nums[2] + _page.nums[_page.second]');
    var expression4 = create('_page.keys[_page.nums[2] - 2]');
    expect(expression.dependencies(context)).to.eql([
      ['_page', 'nums', 0, '*']
    ]);
    expect(expression2.dependencies(context)).to.eql([
